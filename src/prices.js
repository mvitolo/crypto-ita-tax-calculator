...
export const PRICES = {
  bitcoin: {
    ...
    2025: {
      // investing.com BTC/EUR, EUR-native. start = 1 Jan OPEN, end = 31 Dec CLOSE. Raw: data/2025-btc-eur.json
      start: { value: 90166.7, source: "investing.com BTC/EUR open (1 Jan 2025)", retrieved: "2026-06-14" },
      end: { value: 74500.1, source: "investing.com BTC/EUR close (31 Dec 2025)", retrieved: "2026-06-14" },
    },
  },
  ethereum: {
    ...
    2025: {
      // investing.com ETH/EUR, EUR-native. start = 1 Jan OPEN, end = 31 Dec CLOSE. Raw: data/2025-eth-eur.json
      start: { value: 3219.0, source: "investing.com ETH/EUR open (1 Jan 2025)", retrieved: "2026-06-14" },
      end: { value: 2525.99, source: "investing.com ETH/EUR close (31 Dec 2025)", retrieved: "2026-06-14" },
    },
  },
};
